...
import 'package:sophie_messenger_app/services/myprofile/pages/edit_profile.dart';
...
import 'package:sophie_messenger_app/services/message/pages/Screens/Messages/pages/message.dart';
  ...
  static Route<dynamic> onCreateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.chatpersons:
        return _pageRoute(MessageScreen());
      case Routes.searchPerson:
        return _pageRoute(SearchPeopleScreen());
